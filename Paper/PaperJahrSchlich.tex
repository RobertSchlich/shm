...
In several test runs, the properties of the neural network are optimized.


has been tested with varying numbers of training measurements (\autoref{fig:traininputs}).
With increasing numbers of training measurement, the prediction accuracy increases.
...
The implementation of the FFT has been verified by plotting the frequency sprectrum of various vibration measurements, (\autoref{fig:76hzfft}).
