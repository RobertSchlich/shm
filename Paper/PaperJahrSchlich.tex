...
Representing a more efficient approach, analytical redundancy applies knowledge of the structure and the SHM system itself to compute virtual sensor measurements for each sensor. 
...
By implementing the neural networks into the sensor nodes, sensor faults can be detected by individual sensor nodes.
