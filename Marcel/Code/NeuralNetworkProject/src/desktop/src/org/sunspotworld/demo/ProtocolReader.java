...
public class ProtocolReader {
    ...
    /**
     * Sets all important parameters to create the protocol file.
     * 
     * @param length of the data array
     * @param addresses of the different nodes
     * @param defaultPort for the radiostream connection
     * @param sample_period of the measurement
     */
     ...
     * 
     * @param ID "T" for test, "L" for learning
     * @param index
     * @param values
     * @throws IOException
     */
